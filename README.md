...
## Technical Details
- **Performance**: Image preloads for flag icons and project hub icons.
- **PWA Ready**: Installable to home screen on mobile with manifest.json and app icons.
...
## [1.5.2] - 2026-04-19
### Fixed
- Reset button triggering keyboard on mobile
- Mobile scrolling when touching +/- buttons
- Help-icon stuck highlight on mobile
- Focus loop on mobile after pressing Enter
- Input select-all behavior for heightDiff/redNumber
...
- Panel height consistency (uniform 117px height for height/elevation and toggle panels)
- Removed tear line animation from warning container

## [1.5.0] - 2026-04-17
### Major Mobile Overhaul
- **Complete responsive redesign**: Collapsible tank specs, classified-style tank info button, optimized touch targets
...
### Fixed
- Terrain elevation calculation
- Reset button
- Tab navigation
- Tank history content
...
### Improved
- Switched from Tailwind CDN to built CSS file for better performance
- Enhanced viewport settings for better mobile usability and zoom control
- Optimized icon assets (flags resized to 30px, vehicle icons to 28px)
